...
A4_col10_deg_df <- rownames_to_column(A4_col10_deg_df, var = 'Gene')
...
A4_sid10_deg_df <- rownames_to_column(A4_sid10_deg_df, var = 'Gene')
...
A4_col30_deg_df <- rownames_to_column(A4_col30_deg_df, var = 'Gene')
...
A4_sid30_deg_df <- rownames_to_column(A4_sid30_deg_df, var = 'Gene')
...
A4_col1_deg_df <- rownames_to_column(A4_col1_deg_df, var = 'Gene')
...
A4_sid1_deg_df <- rownames_to_column(A4_sid1_deg_df, var = 'Gene')
...
A4_col6_deg_df <- rownames_to_column(A4_col6_deg_df, var = 'Gene')
...
A4_sid6_deg_df <- rownames_to_column(A4_sid6_deg_df, var = 'Gene')
...
A4_col24_deg_df <- rownames_to_column(A4_col24_deg_df, var = 'Gene')
...
A4_sid24_deg_df <- rownames_to_column(A4_sid24_deg_df, var = 'Gene')
...
A4_col48_deg_df <- rownames_to_column(A4_col48_deg_df, var = 'Gene')
...
A4_sid48_deg_df <- rownames_to_column(A4_sid48_deg_df, var = 'Gene')
